    ...
    row.forEach(item => {
      ...
      div.innerHTML = `
        ...
        <div class="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex items-center justify-center">
          <span class="p-2.5 rounded-full bg-black/60 text-white backdrop-blur-sm border border-white/20 transform scale-90 group-hover:scale-100 transition-transform">
